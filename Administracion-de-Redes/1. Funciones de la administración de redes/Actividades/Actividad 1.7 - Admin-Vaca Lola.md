...
El proyecto integrador consiste en diseñar, implementar y documentar la infraestructura técnica y operativa de una empresa productora de carne. El objetivo es aplicar las funciones de administración de redes vistas en el curso: configuración, fallas, contabilidad, desempeño y seguridad, en un escenario realista y funcional.


## 2. Objetivo general

Diseñar e implementar un modelo operativo de una empresa comercial que permita ofrecer conectividad a Internet a los empleados, integrando servicios de red, monitoreo, soporte técnico, seguridad, contabilidad y administración de la infraestructura con un enfoque académico y práctico.
...
La Vaca Lola es corporativo que produce carne de alta calidad. La operación se organiza en 5 regiones y en cada región hay 3 plantas de producción con áreas como: corrales, rastro, empaque, congeladora, embarque y oficinas administrativas. También tiene tiendas donde vende directamente sus productos.
